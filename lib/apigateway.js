...
let createMethodResponse = async(region, apiId, resourceId, method, statusCode, responseModels={}, responseParameters={}) => {
    return await awsreq.put({
        region,
        host:   `apigateway.${region}.amazonaws.com`,
...
let createIntegrationResponse = async(region, apiId, resourceId, method, statusCode) => {
    return await awsreq.put({
        region,
        host:   `apigateway.${region}.amazonaws.com`,
