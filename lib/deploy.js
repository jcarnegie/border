...
var createApi = (function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(msgFn, region, name, desc) {
        var apis, api;
...
var bindEndpointAndFunction = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee18(msgFn, apiSpec, methodSpec) {
...
var go = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee19(action, msgFn, region, env, stage, dest, spec) {
            ...
            while (1) {
                switch (_context19.prev = _context19.next) {
                    ...
                    case 37:
                        ...
                        msgFn("error", _context19.t0.stack);
                        throw _context19.t0;
