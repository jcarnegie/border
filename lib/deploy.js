...
var createApi = (function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(msgFn, region, name, desc) {
        var apis, api;
    ...
    return function createApi(_x, _x2, _x3, _x4) {
        return ref.apply(this, arguments);
    };
})();
...
var createResources = (function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(region, api, spec) {
    ...
    return function createResources(_x5, _x6, _x7) {
        return ref.apply(this, arguments);
    };
})();
...
var listAllFunctions = (function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(region, nextMarker) {
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    ...
                    case 9:
                        moreFns = _context5.sent;
                        return _context5.abrupt("return", _ramda2.default.concat(data.Functions, moreFns));

                    case 13:
                        return _context5.abrupt("return", data.Functions);
    ...
    return function listAllFunctions(_x12, _x13) {
        return ref.apply(this, arguments);
    };
})();
...
var createOrUpdateFunction = (function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(logFn, existingFunctions, params) {
    ...
    return function createOrUpdateFunction(_x14, _x15, _x16) {
        return ref.apply(this, arguments);
    };
})();
...
var installFunctionModules = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(dest, stage, spec) {
...
var createOrUpdateMethod = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(region, apiId, resources, spec, endpointSpec) {
        var resource, params;
            ...
            while (1) {
                switch (_context8.prev = _context8.next) {
                    ...
                    case 8:
                        ...
                        if (!(_context8.t0.message === "Method already exists for this resource")) {
                            _context8.next = 14;
                            break;
                        }
...
var createGatewayLambdaFunction = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(logFn, apiSpec, functionName, zip) {
...
var addMethodPermission = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(logFn, apiSpec, methodSpec, functionName) {
        var res;
...
var createOrUpdateIntegration = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(logFn, apiSpec, methodSpec, resourceId, functionName) {
...
var createOrUpdateMethodResponses = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(logFn, apiSpec, methodSpec, resourceId) {
                ...
                switch (_context13.prev = _context13.next) {
                    case 0:
                        ...
                        createOrUpdate = _ramda2.default.curry((function () {
                            ...
                            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(apiSpec, method, resourceId, response) {
                                    ...
                                    while (1) {
                                        switch (_context12.prev = _context12.next) {
                                            ...
                                            case 6:
                                                ...
                                                return _context12.abrupt("return", _res3);
                                            ...
                                            case 15:
                                                ...
                                                return _context12.abrupt("return", _res4);
                        ...
                        _context13.next = 6;
                        return (0, _util.mapSerialAsync)(createOrUpdate(apiSpec, method, resourceId), responses);
...
var createOrUpdateIntegrationResponses = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee15(logFn, apiSpec, methodSpec, resourceId) {
                ...
                switch (_context15.prev = _context15.next) {
                    ...
                    case 7:
                        createOrUpdate = _ramda2.default.curry((function () {
                            ...
                            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee14(apiSpec, method, resourceId, response) {
...
var zip = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee16(logFn, apiSpec, spec, functionName) {
        var res;
...
var bindEndpointAndFunction = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee17(msgFn, apiSpec, methodSpec) {
...
var go = _ramda2.default.curry((function () {
    ...
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee18(action, msgFn, region, env, stage, dest, spec) {
        ...
        return regeneratorRuntime.wrap(function _callee18$(_context18) {
            while (1) {
                switch (_context18.prev = _context18.next) {
                    ...
                    case 3:
                        accountId = _context18.sent;
                        _context18.next = 6;
                        return createApi(msgFn, region, spec.info.title + "-" + env, spec.info.title);
                    ...
                    case 9:
                        lambdaFunctions = _context18.sent;
                    ...
                    case 14:
                        ...
                        _context18.next = 17;
                        return (0, _util.mapSerialAsync)(installFunctionModules(dest, stage), apiSpec.endpoints);
                    ...
                    case 25:
                        apiSpec.resources = _context18.sent;
                    ...
                    case 29:
                        ...
                        _context18.next = 32;
                        return _bluebird2.default.all(_ramda2.default.map(bindEndpointAndFunction(msgFn, apiSpec), apiSpec.endpoints));
                    ...
                    case 37:
                        ...
                        msgFn("error", _context18.t0.stack);
                        throw _context18.t0;
        ...
        }, _callee18, _this18, [[0, 37]]);
    }));

    return function (_x61, _x62, _x63, _x64, _x65, _x66, _x67) {
        return ref.apply(this, arguments);
    };
})());
