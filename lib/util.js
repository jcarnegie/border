...
exports.updatedSetElements = exports.subpaths = exports.removeLeadingSlash = exports.reduceAsync = exports.mapSerialAsync = exports.cmpObjProps = exports.cmpObj = exports.propNotEq = exports.notNil = exports.mapIndexed = exports.renameProp = exports.mapKeys = undefined;
...
var renameProp = exports.renameProp = _ramda2.default.curry(function (oldProp, newProp, obj) {
    return _ramda2.default.dissoc(oldProp, _ramda2.default.assoc(newProp, _ramda2.default.path(oldProp, obj), obj));
});
...
var updatedSetElements = exports.updatedSetElements = function updatedSetElements(matchPred, diffPred, a, b) {
    var sharedElements = _ramda2.default.intersectionWith(matchPred, a, b);
    var diff = _ramda2.default.differenceWith(diffPred, sharedElements, b);
    return diff;
};
