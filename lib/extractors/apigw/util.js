...
exports.propIsNil = exports.setIf = exports.ensurePathArray = exports.propagateAs = exports.propagate = exports.assocPath = exports.pathExists = undefined;
...
var setIf = exports.setIf = _ramda2.default.curry(function (pred, prop, val, obj) {
    if (pred(obj)) {
...
var propIsNil = exports.propIsNil = _ramda2.default.curry(function (prop, obj) {
    return _ramda2.default.isNil(_ramda2.default.prop(prop, obj));
});
