...
var extract = exports.extract = _ramda2.default.compose(_ramda2.default.map(_ramda2.default.pick(PROPS)), _ramda2.default.map((0, _util.setIf)(_ramda2.default.propEq("selectionPattern", undefined), "selectionPattern", null)), // eslint-disable-line
